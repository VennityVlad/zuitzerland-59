...
export const TeamBadge: React.FC<TeamBadgeProps> = ({ team, size = "md" }) => {
  ...
  const backgroundColor = team.color || "#6E56CF";

  return (
    <div className={`flex items-center justify-center rounded-full ${badgeSizeClass}`} style={{ backgroundColor, width: badgeSizeClass, height: badgeSizeClass }}>
      {team.logo_url ? (
